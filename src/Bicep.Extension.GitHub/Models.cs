...
public class TeamIdentifiers
{
  [TypeProperty("The organization that owns the team", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Org { get; set; }

  [TypeProperty("The team name", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Name { get; set; }
}

[ResourceType("Team")]
public class Team : TeamIdentifiers
{
  [TypeProperty("The team description")]
  public string? Description { get; set; }

  [TypeProperty("The level of privacy the team should have (secret or closed)")]
  public string Privacy { get; set; } = "closed";

  [TypeProperty("The ID of the parent team, if this should be a nested team")]
  public int? ParentTeamId { get; set; }

  [TypeProperty("The team slug generated by GitHub", ObjectTypePropertyFlags.ReadOnly)]
  public string? Slug { get; set; }

  [TypeProperty("The team ID", ObjectTypePropertyFlags.ReadOnly)]
  public int? Id { get; set; }
}

public class TeamMembershipIdentifiers
{
  [TypeProperty("The organization that owns the team", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Org { get; set; }
  ...
  [TypeProperty("The user handle to add to the team", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Username { get; set; }
}

[ResourceType("TeamMembership")]
public class TeamMembership : TeamMembershipIdentifiers
{
  [TypeProperty("The role of the user in the team (member or maintainer)")]
  public string Role { get; set; } = "member";
}

public class OrganizationActionsSecretIdentifiers
{
  [TypeProperty("The organization", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Org { get; set; }
...
[ResourceType("OrganizationActionsSecret")]
public class OrganizationActionsSecret : OrganizationActionsSecretIdentifiers
{
  [TypeProperty("The secret value", ObjectTypePropertyFlags.Required | ObjectTypePropertyFlags.WriteOnly, isSecure: true)]
  public string? Value { get; set; }

  [TypeProperty("Which repositories can access the secret (all, private, or selected)")]
  public string Visibility { get; set; } = "all";

  [TypeProperty("Repository IDs that can access the secret when visibility is 'selected'")]
  public int[]? SelectedRepositoryIds { get; set; }
}

public class OrganizationActionsVariableIdentifiers
{
  [TypeProperty("The organization", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Org { get; set; }
...
[ResourceType("OrganizationActionsVariable")]
public class OrganizationActionsVariable : OrganizationActionsVariableIdentifiers
{
  [TypeProperty("The variable value", ObjectTypePropertyFlags.Required)]
  public required string Value { get; set; }

  [TypeProperty("Which repositories can access the variable (all, private, or selected)")]
  public string Visibility { get; set; } = "all";

  [TypeProperty("Repository IDs that can access the variable when visibility is 'selected'")]
  public int[]? SelectedRepositoryIds { get; set; }
}

public class DependabotSecretIdentifiers
{
  [TypeProperty("The owner of the repository", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Owner { get; set; }
...
[ResourceType("DependabotSecret")]
public class DependabotSecret : DependabotSecretIdentifiers
{
  [TypeProperty("The secret value", ObjectTypePropertyFlags.Required | ObjectTypePropertyFlags.WriteOnly, isSecure: true)]
  public string? Value { get; set; }
}

public class RepositoryActionsPermissionsIdentifiers
{
  [TypeProperty("The owner of the repository", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Owner { get; set; }
...
[ResourceType("RepositoryActionsPermissions")]
public class RepositoryActionsPermissions : RepositoryActionsPermissionsIdentifiers
{
  [TypeProperty("Whether GitHub Actions is enabled for the repository")]
  public bool Enabled { get; set; } = true;

  [TypeProperty("Which actions are allowed to run (all, local_only, or selected)")]
  public string AllowedActions { get; set; } = "all";

  [TypeProperty("The default workflow token permissions (read or write)")]
  public string DefaultWorkflowPermissions { get; set; } = "read";

  [TypeProperty("Whether GitHub Actions can approve pull request reviews")]
  public bool CanApprovePullRequestReviews { get; set; }
}

public class BranchIdentifiers
{
  [TypeProperty("The owner of the repository", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Owner { get; set; }
  ...
  [TypeProperty("The name of the branch to create", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Name { get; set; }
}

[ResourceType("Branch")]
public class Branch : BranchIdentifiers
{
  [TypeProperty("The source branch to create the new branch from. Defaults to the repository default branch")]
  public string? SourceBranch { get; set; }

  [TypeProperty("The source commit SHA to create the new branch from. Takes precedence over sourceBranch")]
  public string? SourceSha { get; set; }

  [TypeProperty("The commit SHA the branch points to", ObjectTypePropertyFlags.ReadOnly)]
  public string? Sha { get; set; }
}

public class EnvironmentSecretIdentifiers
{
  [TypeProperty("The owner of the repository", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Owner { get; set; }
...
public class EnvironmentSecret : EnvironmentSecretIdentifiers
{
  [TypeProperty("The secret value", ObjectTypePropertyFlags.Required | ObjectTypePropertyFlags.WriteOnly, isSecure: true)]
  public string? Value { get; set; }
}

public class EnvironmentVariableIdentifiers
{
  [TypeProperty("The owner of the repository", ObjectTypePropertyFlags.Identifier | ObjectTypePropertyFlags.Required)]
  public required string Owner { get; set; }
...
[ResourceType("EnvironmentVariable")]
public class EnvironmentVariable : EnvironmentVariableIdentifiers
{
  [TypeProperty("The variable value", ObjectTypePropertyFlags.Required)]
  public required string Value { get; set; }
}
